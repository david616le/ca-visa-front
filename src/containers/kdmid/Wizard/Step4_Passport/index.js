    ...
    return (
      <Form {...formItemLayout}>
        ...
        <Row>
          <Col sm={12}>
            <VisaInput 
              label={tr(resources.step_passport.passportNumber.label)}
              extra={tr(resources.step_passport.passportNumber.extra)}
              field="passportNumber"
              initialValue={_.get(data, 'passportNumber')}
              getFieldDecorator={getFieldDecorator}
              maxLength={12}
              customRule={[{ validator: validators.validatePassportNumber }]}
            />
          </Col>
          <Col sm={12}>
            <VisaInput
        ...
        <Row>
          <Col sm={12}>
            <VisaInput 
              ...
              getFieldDecorator={getFieldDecorator}
              maxLength={50}
              customRule={[{ validator: (rule, value, callback) => validators.validateName(rule, value, callback, tr(resources.step_passport.lastName.label)) }]}
            />
          </Col>
          <Col sm={12}>
            <VisaInput
              ...
              getFieldDecorator={getFieldDecorator}
              maxLength={50}
              customRule={[{ validator: (rule, value, callback) => validators.validateName(rule, value, callback, tr(resources.step_passport.firstName.label)) }]}
            />
          </Col>
          <Col sm={12}>
            <VisaDatePicker 
              ...
              getFieldDecorator={getFieldDecorator}
              customRule={[{ validator: validators.validateEarlierDate }]}
        ...
        <Row>
          ...
          <Col sm={12}>
            <VisaSelectItem 
              ...
              content={{
                combines: constants.export_list(constants.countryOfBirth)
              }}
              getFieldDecorator={getFieldDecorator}
            />
          </Col>
          <Col sm={12}>
            <VisaInput
              ...
              getFieldDecorator={getFieldDecorator}
              maxLength={50}
              customRule={[{ validator: (rule, value, callback) => validators.validateAlphaNumericPunctuation(rule, value, callback, tr(resources.step_passport.cityTownOfBirth)) }]}
            />
          </Col>
        </Row>
        ...
        <Row>
          <Col sm={12}>
            <VisaDatePicker 
              label={tr(resources.step_passport.issueDate)}
              field="issueDate"
              initialValue={_.get(data, 'issueDate')}
              getFieldDecorator={getFieldDecorator}
              customRule={[{ validator: validators.validateEarlierDate }]}
          ...
          <Col sm={12}>
            <VisaDatePicker 
              label={tr(resources.step_passport.expiryDate)}
              field="expiryDate"
              initialValue={_.get(data, 'expiryDate')}
              getFieldDecorator={getFieldDecorator}
        ...
        <VisaRadio
          label={tr(resources.step_personal.hasPreviouslyAppliedToCanada)}
          initialValue={_.get(data, 'hasPreviouslyAppliedToCanada')}
          field="hasPreviouslyAppliedToCanada"
          getFieldDecorator={getFieldDecorator}
        />
          ...
          <Row>
            <Col sm={12}>
              <VisaInput 
                ...
                getFieldDecorator={getFieldDecorator}
                maxLength={20}
                customRule={[{ validator: (rule, value, callback) => validators.validateAlphaNumeric(rule, value, callback, false) }]}
              />
            </Col>
            <Col sm={12}>
              <VisaInput
                ...
                getFieldDecorator={getFieldDecorator}
                maxLength={20}
                customRule={[{ validator: (rule, value, callback) => validators.validateReEnter(rule, value, callback, getFieldValue('uci'), 'Values must match', false) }]}
              />
            </Col>
          </Row>
        )}
