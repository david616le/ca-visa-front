    ...
    return (
      <div className="visa-ds160-save-and-continue">
        ...
        <VisaBanner backgroundColor="#428bca">
          Electronic Travel Authorization Application
        </VisaBanner>
        <div className="container visa-ds160-save-and-continue__content">
          {sentAddr && (
            <div className="visa-global-field">
              <h2
                className="visa-global-section-title-customized-by-ds-160"
          ...
          <Form_DS160_SaveAndContinue
            onSendLink={this.onSendLink}
...
export default withCookies(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(DS160_Checkout))
);
