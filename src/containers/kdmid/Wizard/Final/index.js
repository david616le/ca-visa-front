    ...
    return (
      <Form {...formItemLayout}>
        ...
        <div className="visa-form-bottom-btn-group">
          ...
          {showNext && <Button type="primary" onClick={(e) => this.props.handleSubmit(e, this.props.form, this.handleDates)}>{agency ? 'Continue to Your Appointment Information': tr(resources.submit_with_payment)}</Button>}
