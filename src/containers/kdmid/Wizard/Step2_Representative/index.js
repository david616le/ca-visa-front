    ...
    return (
      <Form {...formItemLayout}>
        ...
        <Row>
          ...
          <Col sm={12}>{["2", "3"].includes(getFieldValue("representativeRelationship")) && <VisaInput label={tr(resources.step_representative.province)} field="province" initialValue={_.get(data, "province")} getFieldDecorator={getFieldDecorator} maxLength={50} />}</Col>
        </Row>

        <Row>
          <Col sm={12}>
            <VisaInput label={tr(resources.step_representative.familyName)} field="familyName" initialValue={_.get(data, "familyName")} getFieldDecorator={getFieldDecorator} maxLength={100} customRule={[{ validator: (rule, value, callback) => validators.validateName(rule, value, callback, tr(resources.step_representative.familyName)) }]} />
          </Col>
          <Col sm={12}>
            <VisaInput label={tr(resources.step_representative.firstName)} field="firstName" initialValue={_.get(data, "firstName")} getFieldDecorator={getFieldDecorator} maxLength={100} customRule={[{ validator: (rule, value, callback) => validators.validateName(rule, value, callback, tr(resources.step_representative.familyName)) }]} />
          </Col>
        </Row>

        <Row>
          <Col sm={12}>{["1", "2", "3", "4", "5"].includes(getFieldValue("representativeRelationship")) && <VisaInput label={tr(resources.step_representative.organizationName)} field="organizationName" initialValue={_.get(data, "organizationName")} getFieldDecorator={getFieldDecorator} maxLength={75} />}</Col>
        </Row>

        <Row>
          <Col sm={12}>
            <VisaInput label={tr(resources.step_representative.mailingAddress)} field="mailingAddress" initialValue={_.get(data, "mailingAddress")} getFieldDecorator={getFieldDecorator} maxLength={200} customRule={[{ validator: validators.validateAlphaNumericPunctuation }]} />
          </Col>
          <Col sm={12}>
            <VisaInput
          ...
          <Col sm={12}>
            <VisaInput
              ...
              required={false}
              maxLength={20}
              customRule={[{ validator: (rule, value, callback) => validators.validateNumberSpace(rule, value, callback, tr(resources.step_representative.faxNumber), false) }]}
            />
          </Col>
          <Col sm={12}>
            <VisaInput
              ...
              required={false}
              maxLength={75}
              customRule={[{ validator: (rule, value, callback) => validators.validateEmail(rule, value, callback, tr(resources.step_representative.emailAddress), false) }]}
            />
          </Col>
        </Row>

        <Row>
          <Col sm={12}>{["2", "3"].includes(getFieldValue("representativeRelationship")) && <VisaInput label={tr(resources.step_representative.postalCodeZip)} field="postalCodeZip" initialValue={_.get(data, "postalCodeZip")} getFieldDecorator={getFieldDecorator} maxLength={30} />}</Col>
        </Row>
        ...
        <Form.Item label={tr(resources.step_representative.declareContactAndInformationIsTruthy.label)} required>
          ...
          })(<Checkbox>{tr(resources.step_representative.declareContactAndInformationIsTruthy.extra)}</Checkbox>)}
        </Form.Item>
        ...
        <Form.Item label={tr(resources.step_representative.understandAndAccept.label)} required>
          ...
          })(<Checkbox>{tr(resources.step_representative.understandAndAccept.extra)}</Checkbox>)}
        </Form.Item>
