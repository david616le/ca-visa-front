...
class MyForm extends Component {
  ...
  componentDidMount = () => {
    const { data: consentAndDeclaration } = this.props;
    if (consentAndDeclaration && consentAndDeclaration.signature) {
      this.sigCanvas.fromDataURL(consentAndDeclaration.signature);
    }
  };
  ...
  handleSign = (e) => {
    this.props.form.setFieldsValue({
      signature: this.sigCanvas.toDataURL("image/png"),
    });
  };
  ...
  render() {
    ...
    getFieldDecorator("isTravelDateKnown", {
      initialValue: _.get(data, "isTravelDateKnown"),
    });
      ...
      <Form {...formItemLayout}>
        <div className="visa-global-field visa-global-border-bottom">
          <h2 className="visa-global-section-title">
            {tr(resources.step_consent.section_title_payment)}
          </h2>
          <div className="visa-global-section-description">
            {tr(resources.step_consent.section_descr_payment)}
          </div>
        </div>

        <Form.Item
          label={tr(resources.step_consent.payer.label)}
          required
          style={{ margin: "0px" }}
        >
                ...
                customRule={[
                  {
                    validator: (rule, value, callback) =>
                      validators.validateName(
                        ...
                        value,
                        callback,
                        tr(resources.step_consent.payer.surname)
                      ),
                  },
                ]}
                lang={lang}
                ...
                customRule={[
                  {
                    validator: (rule, value, callback) =>
                      validators.validateName(
                        ...
                        value,
                        callback,
                        tr(resources.step_consent.payer.given_name)
                      ),
                  },
                ]}
                lang={lang}
          ...
          <Col xs={{ span: 24 }} md={{ span: 12 }}>
            <VisaInput
              ...
              customRule={[
                {
                  validator: (rule, value, callback) =>
                    validators.validateNumberSpace(
                      rule,
                      value,
                      callback,
                      tr(resources.step_consent.payer.phone),
                      true
                    ),
                },
              ]}
        ...
        <div className="visa-global-field visa-global-border-bottom">
          <h2 className="visa-global-section-title">
            {tr(resources.step_consent.section_title)}
          </h2>
          {/* <div className="visa-global-section-description">{tr(resources.step_consent.section_description_1)}</div> */}
          <div className="visa-global-section-description">
            {tr(resources.step_consent.section_description_2)}
          </div>
          <div className="visa-global-section-description">
            {tr(resources.step_consent.section_description_3)}
          </div>
          <div className="visa-global-section-description">
            {tr(resources.step_consent.section_description_4)}
          </div>
        </div>

        <Form.Item
          label={tr(resources.step_consent.inAggreance.label)}
          required
        >
          {getFieldDecorator("inAggreance", {
            ...
            <Checkbox>{tr(resources.step_consent.inAggreance.extra)}</Checkbox>
          )}
        </Form.Item>
              ...
              customRule={[
                {
                  validator: (rule, value, callback) =>
                    validators.validateName(
                      ...
                      value,
                      callback,
                      tr(resources.step_consent.fullName.label)
                    ),
                },
              ]}
            />
        ...
        <div className="visa-global-form-bottom-btn-group">
          ...
          <Button
            type="link"
            onClick={(e) =>
              this.props.handleSave(e, this.props.form, this.handleDates)
            }
          >
