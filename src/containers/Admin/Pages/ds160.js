  ...
  render() {
      ...
      },
      {
        ...
        render: (text, record) => {
          ...
          if (record.automation_status.result == 'success') {
            return (<Button type="primary" shape="round" size="small" onClick={() => this.onCheckKdmidStatus(record)}>
              Check Kdmid Status
            </Button>)
          }
          return "-"
    ...
    return (
      <div className="admin-page-ds160">
        {this.state.visible_kdmid_status_modal && <Modal
          title="Check Kdmid Status"
          visible={this.state.visible_kdmid_status_modal}
          footer={null}
        ...
        />
        {/*visible_send_email_modal*/ false && <Modal
